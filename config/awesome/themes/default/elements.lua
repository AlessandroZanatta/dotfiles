...
theme.font = "JetBrainsMono Nerd Font Bold 9" -- "Tamsyn 10" -- "Sans 8"
...
theme.taglist_squares_sel = theme_assets.taglist_squares_sel(taglist_square_size, gmc.color["black"])
theme.taglist_squares_unsel = theme_assets.taglist_squares_unsel(taglist_square_size, gmc.color["white"])
